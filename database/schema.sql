...
-- 2. MÉDICOS (Información específica)
...
-- 4. TURNOS (Optimizada para alta frecuencia)
CREATE TABLE turnos (
    id SERIAL PRIMARY KEY,
...
-- 5. HISTORIALES MÉDICOS (Particionada por fecha)
...
-- Particiones por año (mejora el rendimiento)
CREATE TABLE historiales_2024 PARTITION OF historiales_medicos
    FOR VALUES FROM ('2024-01-01') TO ('2025-01-01');
CREATE TABLE historiales_2025 PARTITION OF historiales_medicos
